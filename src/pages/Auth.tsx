      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-6 group">
            ...
            <span className="text-medical-blue">Back to Home</span>
          </Link>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-4">
                      <label className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-sm text-medical-dark">Patient</span>
                      </label>
                      <label className="flex items-center space-x-2">
                        <input
                          type="radio"
                          ...
                          className="w-4 h-4 text-medical-blue"
                        />
                        <span className="text-sm text-medical-dark">Doctor</span>
                      </label>
                    </div>
                  </div>
        ...
        <p className="text-center text-sm text-medical-gray mt-6">
